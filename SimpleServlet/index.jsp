	...
	<div class="home-container" style="text-align:center;">
		...
		<div class="User_grade_container">		
			<div class="User_ratings User_grade" id="div_fraction0">
				...
				<button onclick="nextstep()" class="next-btn" id="btn_next" disabled="disabled">Assign</button>
				<a href="#" onclick="checklb();return false" class="checklb-btn" id="btn_checklb" >L-Board</a>
